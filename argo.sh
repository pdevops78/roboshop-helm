...
if [ "$1" == "jobs" ]; then
    ...
    argocd app create ${app} --repo https://github.com/pdevops78/roboshop-helm --path chart --upsert --dest-server https://kubernetes.default.svc --dest-namespace default.svc --insecure  --grpc-web --values values/${app}.yaml
    done
fi
